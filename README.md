...
- Latest module source: [nurly-module-1.2.0.tar.gz](http://d2g50xfw6d567v.cloudfront.net/mk23/nurly/nurly-module-1.2.0.tar.gz)
- Latest server source: [nurly-server-1.2.0.tar.gz](http://d2g50xfw6d567v.cloudfront.net/mk23/nurly/nurly-server-1.2.0.tar.gz)
